...
<body >
    ...
    <?php
           ...
           $sql="SELECT * FROM usuarios WHERE idRol  = 3 ORDER BY nombre ASC ";
    ...
    <a href="insertaruser.php"  class="btn btn-succces boton" >Nuevo usuario</a>
    <a href="" class="btn btn-succces boton" onclick="window.print()">Imprimir </a>
    <a href="generarExcel.php" class="btn btn-succces boton"> Excel</a>
    ...
    <table id="myTable">
        ...
        <tbody>
           ...
           <tr>
            ...
            <td class="boton" ><?php echo "<a href='editaruser.php?idUsuario=".$filas ['idUsuario']."'><button>EDITAR</button></a>"; ?>
            -
            <?php echo "<a href='eliminaruser.php?idUsuario=".$filas ['idUsuario']."'><button>ELIMINAR</button> </a>";  ?>
            </td>
           </tr>
           <?php
           }
