...
<body >
    ...
    <!-- open login  -->
            ...
            <form action="subirEmpreArticulos.php" method="post" enctype="multipart/form-data">
              ...
              <div class="form-outline form-white mb-4">
              <label class="form-label" for="producto">Nombre del Producto</label><br>
                <input type="texto" id="producto" name="nombre" class="form-control form-control-lg" />
              </div>
              <div class="form-outline form-white mb-4">
              <label class="form-label" for="precio">Precio del Producto</label><br>
                <input type="number" id="precio" name="precioVenta" class="form-control form-control-lg" />
              </div>
              <div class="form-outline form-white mb-4">
              <label class="form-label" for="stock">Cantidad de Productos</label><br>
                <input type="number" id="stock" name="stock" class="form-control form-control-lg" />
              </div>
              <div class="form-outline form-white mb-4">
              <label class="form-label" for="descripcion">Descripcion del Producto</label><br>
