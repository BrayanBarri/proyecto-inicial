...
<body >
    ...
    <?php
           ...
           $sql="SELECT * FROM articulo WHERE idUsuario = $idUsuario ";
    ...
    <a href="insertarEmpreArticulo.php"  class="btn btn-succces boton" >Nuevo Articulo</a>
    ...
    <table id="myTable">
        ...
        <tbody>
           ...
           <tr>
            ...
            <td class="boton" ><?php echo "<a href='editarEmpreArticulo.php?idArticulo=".$filas ['idArticulo']."'><button>EDITAR</button></a>"; ?>
            -
            <?php echo "<a href='eliminarEmpreArticulo.php?idArticulo=".$filas ['idArticulo']."'><button>ELIMINAR</button> </a>";  ?>
            </td>
           </tr>
           <?php
           }
